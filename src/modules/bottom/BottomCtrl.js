const BottomCtrl = (Monitor, Http, $interval) => {
  ...
  const barColorList2 = ['#007552', '#8B518E', '#F45938', '#FFA040', '#638AC1']
  ...
  function reload() {
    ...
    Monitor.mem().then(
      ...
      _ => {
        Http.get('src/common/json/top5_memory_usage.json').then(function(res) {
          var names = []
          var dataList = []
    ...
    Monitor.vm_cpu().then(
      ...
      _ => {
        Http.get('src/common/json/top5_vm_cpu_usage.json').then(function(res) {
          var names = []
          var dataList = []
...
BottomCtrl.$inject = ['Monitor', 'Http', '$interval']
